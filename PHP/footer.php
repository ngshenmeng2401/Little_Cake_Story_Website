        ...
        <div class="footer-middle">
            <div class="container">
                <div class="row footer">
                    <h4 class="title1 fontsize1">A fun mix of fantastical flavours, right at your doorstep!</h4>
                    <h5 class="content1 marginbottom">Cakes are meant to bring joy and elevate the mood of any occasion. That is why we at Eat Cake Today strives to be the best cake delivery service in Malaysia. Hundreds of mouth-watering, crave-inducing, luscious cakes are available for purchase and are categorized under a number of collections, namely brownies, bundts, cheesecakes, cupcakes, customized cakes, designer cakes, dessert table, eggless cakes, healthy cakes, halal cakes, jelly cakes, loafs, less sweet cakes, macarons, Mille crepes, pastries, vegan dairy-free cakes, and sugar flowers.</h5>
                </div>
                <div class="row mt-2">
                    <div class="col-md-3 col-sm-6 footer">
                        <h4 class="title1 fontsize2">Little Cake Story Links</h4>
                    ...
                    <div class="col-md-5 col-sm-7 footer">
                        <h4 class="title1 fontsize2">Buy Cakes Online For Birthday / Get Together</h4>
                    ...
                    <div class="col-md-4 col-sm-6 footer">
                        <h4 class="title1 fontsize2">Little Cake Story Newsletter</h4>
                        <form>
                            <div class="mb-3">
