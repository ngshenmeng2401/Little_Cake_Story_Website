...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      <div class="container-fluid">
          <img src="../../../assets/images/logo2.png" alt="logo" class="logoimg">
          <a class="navbar-brand" href="#">LITTLE CAKE STORY</a>
          ...
          <ul class="navbar-nav " >
              <li class="nav-item me-3">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="../../pages/signup/signup.html">SignUp</a>
              </li>
              </li>
                  <li class="nav-item">
                  <a class="nav-link" ></a>
